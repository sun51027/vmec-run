...
!undef NETCDF IF TXT DESIRED
     ...
     &  vn_pbeta, vn_tbeta, vn_abeta, vn_b0, vn_p_avg, vn_rbt0, ! Pavg added by Lin 240416
     &  vn_maxmod_nyq,
...
!  Scalars
      ...
      CALL cdf_define(nwout, vn_p_avg, p_avg) ! Added by Lin 240416
...
!
      ...
      CALL cdf_write(nwout, vn_p_avg, p_avg) !Added by Lin 240416
...
! 925  CONTINUE
      ...
      IF (lwouttxt) THEN
         DO js = 1, ns
            !WRITE(nwout2, *) "JS: ", js ! if for vmecv92tprs, open it 24/02/01
