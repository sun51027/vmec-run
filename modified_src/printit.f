...
! Added by Lin 24/02/23
!**********************************************************************
!     WRITE OUT IN FORMAT THAT CAN BE IMPORTED INTO VMEC
!**********************************************************************
      !OPEN(unit=48, file='tovmec', status='unknown')
     ...
     2      THEN
!               IF (m.eq.0 .and. n.ge.0) THEN
!                  WRITE (48, 31) rmnaxis(n), zmnaxis(n)
!               END IF
     ...
     2           "', ZBS(',i",n11,",',',i",m/10+1,",') = ',e14.6)"
               WRITE(48, form_string) n,m,rbc(m,n), n,m,zbs(m,n)
            END IF
         END DO
      END DO
!**********************************************************************
